...
```
### Chart Summary
This chart displays the amount of checkouts for each of Victoria Schwabs Books during 2022. It is important to note that the book "Gallant" was released March 1st, 2022. This release date might impact the popularity of the book in this chart. This chart is important for new commers to Victoria Schwabs work's because it visually explains which books are the most popular. By looking at this chart, the decision of which book to begin consuming Schwabs works with should be a much simpler choice. 

From this chart, there is a clear preference by readers towards the book "The Invisible Life of Addie LaRue" with this book having over 6,000 checkouts in the last year. The next book that is commonly checked out is "A Darker Shade of Magic" with a little over 1,000 checkouts in the last year.